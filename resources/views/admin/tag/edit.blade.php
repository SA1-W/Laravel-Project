        ...
        <form action="{{route('admin.tags.update', $tag->id)}}" class="form-horizontal" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input value="{{$tag->tag_en}}" name="tag_en" type="text" class="form-control" id="fname" placeholder="First Name Here">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input value="{{$tag->tag_ru}}" name="tag_ru" type="text" class="form-control" id="fname" placeholder="First Name Here">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input value="{{$tag->tag_uz}}" name="tag_uz" type="text" class="form-control" id="fname" placeholder="First Name Here">
                    </div>
                </div>
